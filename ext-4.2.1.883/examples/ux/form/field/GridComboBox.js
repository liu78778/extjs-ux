 ...
 *  author: Mac_J
 */
Ext.define('Ext.ux.form.field.GridComboBox', {
	extend : 'Ext.form.field.Picker',
	requires : [ 'Ext.util.DelayedTask', 'Ext.EventObject', 'Ext.view.BoundList',
			'Ext.view.BoundListKeyNav', 'Ext.data.StoreManager', 'Ext.grid.View', 'Ext.ux.view.GridComboBoxList' ],
	...
	createPicker : function() {
		...
		var pk = me.picker = new Ext.ux.view.GridComboBoxList(opts);
		me.mon(pk, {
