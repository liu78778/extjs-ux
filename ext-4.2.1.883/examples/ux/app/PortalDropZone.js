/**
 * @class Ext.ux.app.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Ext.ux.app.PortalPanel}.
 */
Ext.define('Ext.ux.app.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Ext.ux.app.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Ext.ux.app.PortalDropZone.superclass.unreg.call(this);
    }
});
