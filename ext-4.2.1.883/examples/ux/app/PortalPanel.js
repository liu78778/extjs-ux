...
Ext.define('Ext.ux.app.PortalPanel', {
    ...
    requires: [
        ...
        'Ext.ux.app.PortalDropZone',
        'Ext.ux.app.PortalColumn'
    ],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('Ext.ux.app.PortalDropZone', this, this.dropConfig);
    },
